...
public class WTUExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(WTUDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new WTUStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static WTUDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static WTUDateTimeConverter dateTimeConverter = new WTUStandardDateTimeConverter();

    public WTUExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public WTUExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new WTUMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=WTUHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,WTUExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=WTUHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
