...
public class WTUKPSPublicSoap
{
    ...
    public WTUKPSPublicSoap(){}

    public WTUKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public WTUKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        WTUExtendedSoapSerializationEnvelope envelope= new WTUExtendedSoapSerializationEnvelope(WTUExtendedSoapSerializationEnvelope.VER11);
